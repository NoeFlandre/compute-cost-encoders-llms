...
def _model_summaries(summary: Mapping[str, object]) -> list[Mapping[str, object]]:
...
def _timing_section(model_summaries: list[Mapping[str, object]]) -> list[str]:
    rows = [
...
def _comparison_section(model_summaries: list[Mapping[str, object]]) -> list[str]:
    by_model = {
...
def _comparison_values(
    encoder: Mapping[str, object], llm: Mapping[str, object]
) -> (
    tuple[
        float,
        float,
